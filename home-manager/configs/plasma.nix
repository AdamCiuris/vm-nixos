{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-04860410-9337-49e5-9905-82eee1bd1a91" = [ ];
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."04860410-9337-49e5-9905-82eee1bd1a91".value = "Default";
      "kactivitymanagerdrc"."main"."currentActivity".value = "04860410-9337-49e5-9905-82eee1bd1a91";
      ...
      "kdeglobals"."KDE"."widgetStyle".value = "Oxygen";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid".value = "{91a861ac-9b40-46ae-a357-aa1d5170432e}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid".value = "{9fe674cf-78e8-4e2e-b435-972dd2f88411}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid".value = "{0deb2ca8-8fb2-4035-b616-946935a92f31}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid".value = "{8b99fbdd-aef5-4eaf-a6a8-9f0433c12044}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid".value = "{94a286a5-2848-43fb-b17f-edbcff3b3fa7}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid".value = "{37782132-9027-4789-8cdc-3410a5c479f0}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid".value = "{693ec272-cc52-473e-8baa-87856d711eec}";
      ...
      "kwinrc"."Desktops"."Id_1".value = "abe3dd59-4043-4e6e-9fa4-4953db07c15a";
      ...
      "plasmarc"."Theme"."name".value = "oxygen";
    };
  };
}
